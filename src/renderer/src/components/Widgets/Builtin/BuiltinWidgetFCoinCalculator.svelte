<script lang="ts">
  ...
  interface Props {
    ...
    onClose?: () => void;
    onHide?: () => void;
    data?: any; // Optional initialization data for instanced widgets
  }
  ...
  // Load rate from localStorage or use default
