  ...
  <div class="bg-card border border-border rounded-xl shadow-2xl p-8 w-full max-w-md flex flex-col gap-6">
    ...
    <div class="flex flex-col gap-1 text-center">
      ...
      <p class="text-sm text-muted-foreground">
        {#if phase === 'idle'}
          NeuzOS needs to download the Flyff Universe skill database to power skill related features.
    ...
    {:else if phase === 'done'}
      <div class="flex flex-col items-center gap-2 py-2">
        ...
        <p class="text-sm text-muted-foreground">Skill features are ready to use.</p>
      </div>
